...
class Page {
    ...
    protected $config  =    array('header'=>'条记录','prev'=>'Prev','next'=>'Next','first'=>'<<','last'=>'>>','theme'=>'<ul> %first%  %prePage%  %linkPage%  %nextPage% %end% </ul>');
    // 默认分页变量名
    protected $varPage;
        ...
        for($i=1;$i<=$this->rollPage;$i++){
            ...
            if($page!=$this->nowPage){
                ...
                if($this->totalPages != 1){
                    $linkPage .= "<li><a class='current' style='background:whiteSmoke;color:#999'>".$page."</a></li>";
                }
            }
        }
        $pageStr     =   str_replace(
